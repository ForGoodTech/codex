...
echo "Firecracker debug VM is running."
...
echo "SSH command:"
echo "  ssh -i $DEBUG_SSH_PRIVATE_KEY_FILE -o StrictHostKeyChecking=no -o UserKnownHostsFile=$KNOWN_HOSTS ${SSH_USER}@${GUEST_IP}"
echo
echo "Serial console follows below. Leave this terminal running; use a second terminal for SSH."
