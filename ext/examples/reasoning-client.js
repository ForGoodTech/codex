 ...
 * prompt, waits for the final assistant reply, prints it (reasoning notifications stay internal, but show a dot for
 * each one), and prompts again.
 *
 ...
 * - Reasoning notifications are handled to keep the local state consistent; each one prints a dot as a lightweight
 *   progress indicator without revealing details.
 * - Only the final assistant response is printed when the turn completes, preceded by a blank line separator.
